        ...
        with open(batch_pickle_dir, "rb") as fr:
            ...
            for example in examples:
                ...
                if batch_capacity > max_batch_capcity or batch_size > max_batch or batch_capacity_size > max_batch_total_capcity:
                    ...
                    print(src_batch.size(), dst_batch.size(), batch_capacity, batch_size, batch_capacity_size, len(cur_src_batch[:-1]), len(cur_dst_batch[:-1]),cur_max_src_len, cur_max_dst_len)
